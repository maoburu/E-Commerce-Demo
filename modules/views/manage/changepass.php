                        ...
                        <div class="container">
                            <?php
                                ...
                                $form = ActiveForm::begin([
                                    ...
                                    'fieldConfig' =>[
                                        'template' => '<div class="pan12 field-box">{label}{input}</div>{error}'
                                    ],
                                ])
                            ?>
                                <?php echo $form->field($model, 'adminuser')->textInput(['class' => 'span9', 'disabled' => true]); ?>
                                <?php echo $form->field($model, 'adminpass')->passwordInput(['class' => 'span9'])->label('新密码'); ?>
