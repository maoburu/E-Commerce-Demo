        ...
        <div class="col-xs-12 no-margin">
            ...
            <div class="billing-address" style="display:none;">
                ...
                <?php ActiveForm::begin([
                    ...
                    <div class="row field-row">
                        <div class="col-xs-12 col-sm-6">
                            <label>地址*</label>
                            <input name="address1" class="le-input" data-placeholder="例如：北京市朝阳区" >
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <label>&nbsp;</label>
                            <input name="address2" class="le-input" data-placeholder="例如：酒仙桥北路" >
                        </div>
                    </div><!-- /.field-row -->
                ...
                <div class="col-xs-12 col-lg-4 col-lg-offset-8 no-margin-right">
                    <div id="subtotal-holder">
                        <ul class="tabled-data inverse-bold no-border">
                            <li>
                                <label>商品总价</label>
                                <div style="width:100%;text-align:right" class="value ">￥<span><?php echo $total; ?></span></div>
                            </li>
                            <li>
                                <label>选择快递</label>
                                <div style="width:100%;text-align:right" class="value">
                                    ...
                                    <?php foreach($express as $k => $e): ?>
                                        ...
                                        <input class="le-radio express" type="radio" name="expressid" value="<?php echo $k ?>" data="<?php echo $expressPrice[$k] ?>" checked="<?php echo $checked; ?>"> <div class="radio-label bold"><?php echo $e ?><span class="bold"> ￥<?php echo $expressPrice[$k] ?></span></div><br>
                                    <?php endforeach; ?>
                                    </div>
                                </div>
                            </li>
            ...
            <div id="payment-method-options">
                    ...
                    <div class="payment-method-option">
                        <input class="le-radio" type="radio" name="paymethod" value="alipay" checked="checked" />
