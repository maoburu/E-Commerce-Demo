...
<?php $total = 0; ?>
<?php foreach((array)$data as $k => $pro): ?>
            ...
            <input type="hidden" name="OrderDetail[<?php echo $k?>][productnum]" value="<?php echo $pro['productnum'] ?>">
            <div class="row no-margin cart-item">
                <div class="col-xs-12 col-sm-2 no-margin">
                    <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']])?>" class="thumb-holder">
                        <img class="lazy" alt="" src="<?php echo $pro['cover']?>-picsmall" />
                    </a>
                </div>
                ...
                <div class="col-xs-12 col-sm-3 no-margin">
                    <div class="quantity">
                        <div class="le-quantity">
                                ...
                                <input name="productnum" id="<?php echo $pro['cartid'] ?>" readonly="readonly" type="text" value="<?php echo $pro['productnum'] ?>" />
            ...
            <div class="widget cart-summary">
                ...
                <div class="body">
                    ...
                    <ul id="total-price" class="tabled-data inverse-bold no-border">
                        <li>
                            <label>订单总价</label>
                            <div class="value pull-right">￥ <span><?php echo $total + 10 ?></div>
                        </li>
                    </ul>
                    <div class="buttons-holder">
                        <input type="submit" class="le-button big" value="去结算"></input>
